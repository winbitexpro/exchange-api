...
//1. Get Ticker
//Symbol = BCH_BTC
/* api.getTicker('BCH_BTC').then(res => { console.log(res, '\n') }); */
/* {
    "status":"ok",
    "ticker":[
        {
...
//Symbol = BCH_BTC & depth = 2
//api.getTrade('BCH_BTC', 2).then(res => { console.log(res, '\n') });
/* {
    "status":"ok",
    "trades":[
        {
...
//6. Get Order Book
//symbol = BCH_BTC
/* api.getOrderbook('BCH_BTC').then(res => { console.log(res, '\n') });
{
    "status":"ok",
